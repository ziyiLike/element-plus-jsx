...
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"  })")]),i(`
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"}")]),i(`
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),s("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"script"),s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1)])),default:a(()=>[n(v)]),_:1}),l[45]||(l[45]=d('<h2 id="表单配置" tabindex="-1">表单配置 <a class="header-anchor" href="#表单配置" aria-label="Permalink to &quot;表单配置&quot;">​</a></h2><p><code>el-formx</code>兼容了所有的 element-plus 表单组件, 通过配置项的<code>type</code>属性可指定需要渲染的组件。</p><p>::: tips 原则上，<code>type</code>的属性即为<code>el-xxx</code>的组件名。 例如：<code>type=&quot;input&quot;</code>，则渲染<code>el-input</code>组件。 同时对应的组件参数 Props 属性为<code>${type}Props</code>，例如：<code>type=&quot;input&quot;</code>，则透传 Props 属性为<code>inputProps</code>。以下是一些例外情况 :::</p><h3 id="el-input-number" tabindex="-1">el-input-number <a class="header-anchor" href="#el-input-number" aria-label="Permalink to &quot;el-input-number&quot;">​</a></h3><p>透传 input 的 inputProps 属性<code>type</code>设置为<code>input-number</code>时渲染<code>el-input-number</code>组件</p>',5)),n(k,{customClass:"",sourceCode:`<template>
