import{a as m,E as r}from"./chunks/theme.DuRLZATH.js";import{x as u,r as C,ag as n,y as g,z as y,P as h,H as p,L as i,u as b,O as B,aQ as d,A as s}from"./chunks/framework.CdoyD7j2.js";const f=u({__name:"tablex.md.demo.0bad0862",setup(o){const e=C(),l=[{name:"张三",sex:0,address:"北京",enable:!0},{name:"李四",sex:1,address:"上海",enable:!1},{name:"王五",sex:1,address:"广州",enable:!0}],k=m([{type:"selection",width:55,selectable:a=>a.name!=="王五"},{prop:"name",label:"姓名"},{prop:"sex",label:"性别"},{prop:"address",slots:{header:()=>h("div",{style:"color:var(--el-color-primary)"},[i("地址")])}},{label:"启用",slots:{default:({row:a})=>h(n("el-switch"),{modelValue:a.enable,"onUpdate:modelValue":t=>a.enable=t},null)}},{label:"操作",slots:{default:({row:a})=>h(n("el-button"),{onClick:()=>r.success(a.name)},{default:()=>[i("添加")]})}}],{align:"center"}),c=()=>{var t;((t=e.value)==null?void 0:t.tableRef.getSelectionRows()).forEach(E=>{r.success(E.name)})};return(a,t)=>{const E=n("el-button"),F=n("el-tablex");return g(),y(B,null,[h(E,{style:{"margin-bottom":"20px"},onClick:c},{default:p(()=>t[0]||(t[0]=[i("选中")])),_:1}),h(F,{ref_key:"tableRef",ref:e,border:"",data:l,columns:b(k)},null,8,["columns"])],64)}}}),w=JSON.parse('{"title":"表格 Tablex","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"pages/compoents/tablex.md","filePath":"pages/compoents/tablex.md","lastUpdated":1741944691000}'),A={name:"pages/compoents/tablex.md"},v=Object.assign(A,{setup(o){return(e,l)=>{const k=n("demo");return g(),y("div",null,[l[1]||(l[1]=d('<h1 id="表格-tablex" tabindex="-1">表格 Tablex <a class="header-anchor" href="#表格-tablex" aria-label="Permalink to &quot;表格 Tablex&quot;">​</a></h1><p>组件<code>el-tablex</code>完全等同于<code>el-table</code>，可以完全平替使用，组件本身未做任何更改。</p><h4 id="基础使用" tabindex="-1">基础使用 <a class="header-anchor" href="#基础使用" aria-label="Permalink to &quot;基础使用&quot;">​</a></h4><p>在<code>el-table</code>基础上仅增加一个属性<code>columns</code>, 接收一个数组，用于配置相应的表格列，所有属性均透传至<code>el-table-column</code>。</p><div class="info custom-block"><p class="custom-block-title">INFO</p><p>推荐使用 Hook <code>useColumns</code> 提供配置项提示以及对应类型检查。</p></div>',5)),h(k,{customClass:"",sourceCode:`<template>
...
<\/script>
`,options:"{}"},{highlight:p(()=>l[0]||(l[0]=[s("div",{class:"language-vue vp-adaptive-theme"},[s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0","v-pre":""},[s("code",null,[s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"<"),s("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"template"),s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")]),i(`
...
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"  })")]),i(`
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"}")]),i(`
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),s("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"script"),s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1)])),default:p(()=>[h(f)]),_:1}),l[2]||(l[2]=d('<h4 id="tablex-props" tabindex="-1">Tablex Props <a class="header-anchor" href="#tablex-props" aria-label="Permalink to &quot;Tablex Props&quot;">​</a></h4><div class="vp-table"><table tabindex="0"><thead><tr><th>名称</th><th>类型</th><th>默认值</th><th>说明</th></tr></thead><tbody><tr><td>columns</td><td><code>TableColumn&lt;T&gt;[]</code></td><td>[]</td><td>表格列配置</td></tr><tr><td>plugins</td><td><code>Fn&lt;TableColumn&lt;any&gt;[]&gt;[]</code></td><td>[]</td><td>表格插件（优先级最高 level: 1）</td></tr></tbody></table></div>',2))])}}});export{w as __pageData,v as default};
