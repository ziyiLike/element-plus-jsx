import{u as m,E as r}from"./chunks/theme.CPje7okV.js";import{m as u,a as C,ai as n,p as g,q as y,U as t,O as p,S as i,u as b,F as B,aQ as d,t as s}from"./chunks/framework.hHPugXBv.js";const f=u({__name:"tablex.md.demo.0bad0862",setup(o){const k=C(),a=[{name:"张三",sex:0,address:"北京",enable:!0},{name:"李四",sex:1,address:"上海",enable:!1},{name:"王五",sex:1,address:"广州",enable:!0}],e=m([{type:"selection",width:55,selectable:l=>l.name!=="王五"},{prop:"name",label:"姓名"},{prop:"sex",label:"性别"},{prop:"address",slots:{header:()=>t("div",{style:"color:var(--el-color-primary)"},[i("地址")])}},{label:"启用",slots:{default:({row:l})=>t(n("el-switch"),{modelValue:l.enable,"onUpdate:modelValue":h=>l.enable=h},null)}},{label:"操作",slots:{default:({row:l})=>t(n("el-button"),{onClick:()=>r.success(l.name)},{default:()=>[i("添加")]})}}],{align:"center"}),F=()=>{var h;((h=k.value)==null?void 0:h.tableRef.getSelectionRows()).forEach(E=>{r.success(E.name)})};return(l,h)=>{const E=n("el-button"),c=n("el-tablex");return g(),y(B,null,[t(E,{style:{"margin-bottom":"20px"},onClick:F},{default:p(()=>h[0]||(h[0]=[i("选中")])),_:1}),t(c,{ref_key:"tableRef",ref:k,class:"vp-raw",border:"",data:a,columns:b(e)},null,8,["columns"])],64)}}}),w=JSON.parse('{"title":"表格 Tablex","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"pages/compoents/tablex.md","filePath":"pages/compoents/tablex.md","lastUpdated":1730340748000}'),A={name:"pages/compoents/tablex.md"},v=Object.assign(A,{setup(o){return(k,a)=>{const e=n("demo");return g(),y("div",null,[a[1]||(a[1]=d('<h1 id="表格-tablex" tabindex="-1">表格 Tablex <a class="header-anchor" href="#表格-tablex" aria-label="Permalink to &quot;表格 Tablex&quot;">​</a></h1><p>组件<code>el-tablex</code>完全等同于<code>el-table</code>，可以完全平替使用，组件本身未做任何更改。</p><h4 id="基础使用" tabindex="-1">基础使用 <a class="header-anchor" href="#基础使用" aria-label="Permalink to &quot;基础使用&quot;">​</a></h4><p>在<code>el-table</code>基础上仅增加一个属性<code>columns</code>, 接收一个数组，用于配置相应的表格列，所有属性均透传至<code>el-table-column</code>。`</p><blockquote><p>推荐使用 Hook <code>useColumns</code> 提供配置项提示以及对应类型检查。</p></blockquote>',5)),t(e,{customClass:"",sourceCode:`<template>
